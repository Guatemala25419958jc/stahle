...
export default function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const stats = product.stats?.length ? product.stats : [["01", "Material", product.materials?.[0] || "A medida"], ["02", "Ambiente", product.room], ["03", "Medidas", product.dimensions || "Personalizables"]];
